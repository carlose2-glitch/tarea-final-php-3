...
<body>
    ...
    <div class="w-full flex gap-4 justify-end p-4">
        <a href="index.php">Inicio</a> | <a href="registrarse.php">Registrarse</a>
    </div>
            ...
            <div class="relative min-h-screen flex flex-col sm:justify-center items-center bg-gray-100 ">
                <div class="relative sm:max-w-sm w-full">
                    ...
                    <div class="relative w-full rounded-3xl  px-6 py-4 bg-gray-100 shadow-md">
                        ...
                        <form method="post" action="validacion.php" class="mt-10">
                                           
                            <div>
                                <input type="text" name="usuario" placeholder="Usuario" class="pl-2 mt-1 block w-full border-none bg-gray-100 h-11 rounded-xl shadow-lg hover:bg-blue-100 focus:bg-blue-100 focus:ring-0">
                            </div>
